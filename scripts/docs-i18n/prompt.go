...
- Keep product names in English: Bobolt, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Bobolt Gateway, use “Gateway 网关”.

...
export OPENCLAW_STATE_DIR="/tmp/bobolt-test"
export OPENCLAW_CONFIG_PATH="${OPENCLAW_STATE_DIR}/bobolt.json"
...
pnpm bobolt reset --scope config+creds+sessions --yes --non-interactive
...
pnpm bobolt uninstall --state --yes --non-interactive

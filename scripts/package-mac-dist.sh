...
# Output:
# - dist/Bobolt.app
# - dist/Bobolt-<version>.zip
# - dist/Bobolt-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Bobolt-$VERSION.zip"
DMG="$ROOT_DIR/dist/Bobolt-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Bobolt-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Bobolt-$VERSION.dSYM.zip"

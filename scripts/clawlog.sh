...
show_usage() {
    cat << EOF
clawlog - Bobolt Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Bobolt logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Bobolt logs flow through the macOS unified log (subsystem: ai.bobolt).

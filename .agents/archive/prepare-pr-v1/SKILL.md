...
- `fix: <summary> (bobolt#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (bobolt#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "bobolt#$pr_number" || { echo "ERROR: commit subject missing bobolt#$pr_number"; exit 1; }

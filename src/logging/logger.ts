...
export const DEFAULT_LOG_DIR = "/tmp/bobolt";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "bobolt.log"); // legacy single-file path

const LOG_PREFIX = "bobolt";
...
function resolveSettings(): ResolvedSettings {
  let cfg: BoboltConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => BoboltConfig;
      };

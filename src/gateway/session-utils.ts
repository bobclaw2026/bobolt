...
import { type BoboltConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: BoboltConfig): string[] {
...
export function listAgentsForGateway(cfg: BoboltConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: BoboltConfig): string {
...
function resolveSessionStoreAgentId(cfg: BoboltConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: BoboltConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: BoboltConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: BoboltConfig): GatewaySessionsDefaults {

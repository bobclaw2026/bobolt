...
import type { BoboltConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: BoboltConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: BoboltConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: BoboltConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: BoboltConfig) => void;
  log: {

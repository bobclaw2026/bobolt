...
export function listSignalAccountIds(cfg: BoboltConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: BoboltConfig): string {
...
function mergeSignalAccountConfig(cfg: BoboltConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: BoboltConfig): ResolvedSignalAccount[] {

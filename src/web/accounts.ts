...
function listConfiguredAccountIds(cfg: BoboltConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: BoboltConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: BoboltConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: BoboltConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: BoboltConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: BoboltConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: BoboltConfig): ResolvedWhatsAppAccount[] {

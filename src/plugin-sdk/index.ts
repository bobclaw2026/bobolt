...
export type { BoboltConfig } from "../config/config.js";
/** @deprecated Use BoboltConfig instead */
export type { BoboltConfig as ClawdbotConfig } from "../config/config.js";

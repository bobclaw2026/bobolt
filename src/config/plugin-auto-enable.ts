import type { BoboltConfig } from "./config.js";
...
function isTelegramConfigured(cfg: BoboltConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: BoboltConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: BoboltConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: BoboltConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: BoboltConfig): boolean {
...
function isIMessageConfigured(cfg: BoboltConfig): boolean {
...
function isWhatsAppConfigured(cfg: BoboltConfig): boolean {
...
function isGenericChannelConfigured(cfg: BoboltConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: BoboltConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: BoboltConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: BoboltConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: BoboltConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: BoboltConfig, pluginId: string): BoboltConfig {
...
function registerPluginEntry(cfg: BoboltConfig, pluginId: string): BoboltConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {

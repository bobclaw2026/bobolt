import type { BoboltConfig } from "./types.js";
...
function resolveAnthropicDefaultAuthMode(cfg: BoboltConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: BoboltConfig): BoboltConfig {
...
export function applyTalkApiKey(config: BoboltConfig): BoboltConfig {
...
export function applyModelDefaults(cfg: BoboltConfig): BoboltConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: BoboltConfig): BoboltConfig {
...
export function applyLoggingDefaults(cfg: BoboltConfig): BoboltConfig {
...
export function applyContextPruningDefaults(cfg: BoboltConfig): BoboltConfig {
...
export function applyCompactionDefaults(cfg: BoboltConfig): BoboltConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }

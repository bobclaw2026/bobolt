...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: BoboltConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: BoboltConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: BoboltConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: BoboltConfig): void {

...
export type ChannelAgentToolFactory = (params: { cfg?: BoboltConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: BoboltConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: BoboltConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: BoboltConfig }) => boolean;
  supportsCards?: (params: { cfg: BoboltConfig }) => boolean;

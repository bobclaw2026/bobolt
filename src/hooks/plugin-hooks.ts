...
import type { BoboltPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: BoboltPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: BoboltPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,

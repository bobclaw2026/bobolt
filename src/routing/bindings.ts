...
export function listBindings(cfg: BoboltConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: BoboltConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: BoboltConfig) {

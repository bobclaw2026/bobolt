...
export function listIMessageAccountIds(cfg: BoboltConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: BoboltConfig): string {
...
function mergeIMessageAccountConfig(cfg: BoboltConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: BoboltConfig): ResolvedIMessageAccount[] {

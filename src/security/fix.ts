...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof BoboltConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: BoboltConfig; env: NodeJS.ProcessEnv }): {
  cfg: BoboltConfig;
  changes: string[];
  policyFlips: Set<string>;
} {

...
export const A2UI_PATH = "/__bobolt__/a2ui";

export const CANVAS_HOST_PATH = "/__bobolt__/canvas";

export const CANVAS_WS_PATH = "/__bobolt__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.boboltCanvasA2UIAction.postMessage(...)
  // - Android: window.boboltCanvasA2UIAction.postMessage(...)
  const handlerNames = ["boboltCanvasA2UIAction"];
  ...
  globalThis.Bobolt = globalThis.Bobolt ?? {};
  globalThis.Bobolt.postMessage = postToNode;
  globalThis.Bobolt.sendUserAction = sendUserAction;
  globalThis.boboltPostMessage = postToNode;
  globalThis.boboltSendUserAction = sendUserAction;

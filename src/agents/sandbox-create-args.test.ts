  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "bobolt.sandbox=1",
        "--label",
        "bobolt.sessionKey=main",
        "--label",
        "bobolt.createdAtMs=1700000000000",
        "--label",
        "bobolt.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",

...
describe("createBoboltCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createBoboltCodingTools({
      config,
    ...
    const anthropicTools = createBoboltCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createBoboltCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createBoboltCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });

...
function resolveWatchPaths(workspaceDir: string, config?: BoboltConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: BoboltConfig }) {

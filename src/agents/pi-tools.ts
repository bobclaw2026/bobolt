...
function resolveExecConfig(cfg: BoboltConfig | undefined) {
...
export function createBoboltCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createBoboltReadTool(freshReadTool)];
    }

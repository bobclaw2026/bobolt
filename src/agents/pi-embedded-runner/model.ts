...
// pi-ai's built-in Anthropic catalog can lag behind Bobolt's defaults/docs.
...
export function buildModelAliasLines(cfg?: BoboltConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveBoboltAgentDir();

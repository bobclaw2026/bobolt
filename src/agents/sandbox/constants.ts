...
export const DEFAULT_SANDBOX_IMAGE = "bobolt-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "bobolt-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "bobolt-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "bobolt-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "bobolt-sbx-browser-";

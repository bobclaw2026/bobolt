...
function resolveAvatarSource(cfg: BoboltConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: BoboltConfig, agentId: string): AgentAvatarResolution {

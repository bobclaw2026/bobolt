...
export function listSlackAccountIds(cfg: BoboltConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: BoboltConfig): string {
...
function mergeSlackAccountConfig(cfg: BoboltConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: BoboltConfig): ResolvedSlackAccount[] {

...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@bobolt", { botUsername: "bobolt" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@bobolt args", {
        botUsername: "bobolt",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "bobolt" })).toBe(
      "/help@otherbot",
    );
  });

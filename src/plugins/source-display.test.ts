...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/bobolt/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/bobolt/extensions",
        global: "/Users/x/.bobolt/extensions",
        workspace: "/Users/x/ws/.bobolt/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.bobolt/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/bobolt/extensions",
        global: "/Users/x/.bobolt/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.bobolt/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/bobolt/extensions",
        global: "/Users/x/.bobolt/extensions",

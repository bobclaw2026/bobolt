...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @bobolt/voice-call -> voice-call).
...
export function discoverBoboltPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".bobolt", "extensions")];

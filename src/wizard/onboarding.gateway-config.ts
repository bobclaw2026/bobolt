...
import type { GatewayBindMode, GatewayTailscaleMode, BoboltConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.bobolt.ai/gateway/tailscale", "https://docs.bobolt.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );

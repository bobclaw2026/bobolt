...
export function listTelegramAccountIds(cfg: BoboltConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: BoboltConfig): string {
...
function mergeTelegramAccountConfig(cfg: BoboltConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: BoboltConfig): ResolvedTelegramAccount[] {

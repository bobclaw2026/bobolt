...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    process.env.OPENCLAW_STATE_DIR = "/tmp/bobolt-cli-state";
    process.env.OPENCLAW_CONFIG_PATH = "/tmp/bobolt-cli-state/bobolt.json";
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        ...
        OPENCLAW_STATE_DIR: "/tmp/bobolt-daemon-state",
        OPENCLAW_CONFIG_PATH: "/tmp/bobolt-daemon-state/bobolt.json",

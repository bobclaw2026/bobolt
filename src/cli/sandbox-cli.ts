...
const SANDBOX_EXAMPLES = {
  main: [
    ["bobolt sandbox list", "List all sandbox containers."],
    ["bobolt sandbox list --browser", "List only browser containers."],
    ["bobolt sandbox recreate --all", "Recreate all containers."],
    ["bobolt sandbox recreate --session main", "Recreate a specific session."],
    ["bobolt sandbox recreate --agent mybot", "Recreate agent containers."],
    ["bobolt sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["bobolt sandbox list", "List all sandbox containers."],
    ["bobolt sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["bobolt sandbox recreate --all", "Recreate all containers."],
    ["bobolt sandbox recreate --session main", "Recreate a specific session."],
    ["bobolt sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["bobolt sandbox recreate --browser --all", "Recreate only browser containers."],
    ["bobolt sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["bobolt sandbox explain", "Show effective sandbox config."],
    ["bobolt sandbox explain --session agent:main:main", "Explain a specific session."],
    ["bobolt sandbox explain --agent work", "Explain an agent sandbox."],
    ["bobolt sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.bobolt.ai/cli/sandbox")}\n`,
    )
    .action(() => {

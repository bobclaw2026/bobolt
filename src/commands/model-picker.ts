...
function resolveConfiguredModelRaw(cfg: BoboltConfig): string {
...
function resolveConfiguredModelKeys(cfg: BoboltConfig): string[] {
...
export function applyPrimaryModel(cfg: BoboltConfig, model: string): BoboltConfig {
...
export function applyModelAllowlist(cfg: BoboltConfig, models: string[]): BoboltConfig {
  const defaults = cfg.agents?.defaults;

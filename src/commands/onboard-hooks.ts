...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.bobolt.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("bobolt hooks list")}`,
      `  ${formatCliCommand("bobolt hooks enable <name>")}`,
      `  ${formatCliCommand("bobolt hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );

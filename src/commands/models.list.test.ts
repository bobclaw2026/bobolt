...
const ensureBoboltModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveBoboltAgentDir = vi.fn().mockReturnValue("/tmp/bobolt-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/bobolt-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureBoboltModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveBoboltAgentDir,
}));

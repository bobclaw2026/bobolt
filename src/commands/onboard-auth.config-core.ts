...
export function applyZaiConfig(cfg: BoboltConfig): BoboltConfig {
...
export function applyOpenrouterProviderConfig(cfg: BoboltConfig): BoboltConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: BoboltConfig): BoboltConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: BoboltConfig): BoboltConfig {
...
export function applyOpenrouterConfig(cfg: BoboltConfig): BoboltConfig {
...
export function applyLitellmProviderConfig(cfg: BoboltConfig): BoboltConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyLitellmConfig(cfg: BoboltConfig): BoboltConfig {
...
export function applyMoonshotProviderConfig(cfg: BoboltConfig): BoboltConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: BoboltConfig): BoboltConfig {
...
export function applyMoonshotConfig(cfg: BoboltConfig): BoboltConfig {
...
export function applyMoonshotConfigCn(cfg: BoboltConfig): BoboltConfig {
...
export function applyKimiCodeProviderConfig(cfg: BoboltConfig): BoboltConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: BoboltConfig): BoboltConfig {
...
export function applySyntheticProviderConfig(cfg: BoboltConfig): BoboltConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: BoboltConfig): BoboltConfig {
...
export function applyXiaomiProviderConfig(cfg: BoboltConfig): BoboltConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: BoboltConfig): BoboltConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: BoboltConfig): BoboltConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: BoboltConfig): BoboltConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: BoboltConfig): BoboltConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: BoboltConfig): BoboltConfig {
...
export function applyXaiProviderConfig(cfg: BoboltConfig): BoboltConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: BoboltConfig): BoboltConfig {
...
export function applyQianfanProviderConfig(cfg: BoboltConfig): BoboltConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: BoboltConfig): BoboltConfig {

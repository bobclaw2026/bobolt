...
export async function statusCommand(
  ...
  runtime.log(theme.heading("Bobolt status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("bobolt security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("bobolt security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.bobolt.ai/faq");
  runtime.log("Troubleshooting: https://docs.bobolt.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("bobolt status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("bobolt logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("bobolt status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("bobolt gateway probe")}`);
  }
}

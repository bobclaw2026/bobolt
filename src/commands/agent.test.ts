...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "bobolt-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<BoboltConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<BoboltConfig["telegram"]>>,

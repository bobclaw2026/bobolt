...
function resolveDefaultAccountId(cfg: BoboltConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: BoboltConfig): boolean {
...
export function summarizeBindings(cfg: BoboltConfig, bindings: AgentBinding[]): string[] {

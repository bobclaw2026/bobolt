# 🦞 Bobolt — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/bobolt/bobolt/main/docs/assets/bobolt-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/bobolt/bobolt/main/docs/assets/bobolt-logo-text.png" alt="Bobolt" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/bobolt/bobolt/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/bobolt/bobolt/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/bobolt/bobolt/releases"><img src="https://img.shields.io/github/v/release/bobolt/bobolt?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Bobolt** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://bobolt.ai) · [Docs](https://docs.bobolt.ai) · [DeepWiki](https://deepwiki.com/bobolt/bobolt) · [Getting Started](https://docs.bobolt.ai/start/getting-started) · [Updating](https://docs.bobolt.ai/install/updating) · [Showcase](https://docs.bobolt.ai/start/showcase) · [FAQ](https://docs.bobolt.ai/start/faq) · [Wizard](https://docs.bobolt.ai/start/wizard) · [Nix](https://github.com/bobolt/nix-bobolt) · [Docker](https://docs.bobolt.ai/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`bobolt onboard`) in your terminal.
The wizard guides you step by step through setting up the gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.bobolt.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.6** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.bobolt.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.bobolt.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.bobolt.ai/concepts/model-failover)
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.bobolt.ai/start/getting-started)

```bash
bobolt onboard --install-daemon

bobolt gateway --port 18789 --verbose

# Send a message
bobolt message send --to +1234567890 --message "Hello from Bobolt"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
bobolt agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.bobolt.ai/install/updating) (and run `bobolt doctor`).
...
Switch channels (git + npm): `bobolt update --channel stable|beta|dev`.
Details: [Development channels](https://docs.bobolt.ai/install/development-channels).
...
pnpm bobolt onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm bobolt ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `bobolt` binary.

## Security defaults (DM access)

Bobolt connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.bobolt.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `bobolt pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `bobolt doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.bobolt.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.bobolt.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.bobolt.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.bobolt.ai/nodes/voicewake) + [Talk Mode](https://docs.bobolt.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.bobolt.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.bobolt.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.bobolt.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.bobolt.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.bobolt.ai/nodes).
- **[Onboarding](https://docs.bobolt.ai/start/wizard) + [skills](https://docs.bobolt.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=bobolt/bobolt&type=date&legend=top-left)](https://www.star-history.com/#bobolt/bobolt&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.bobolt.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.bobolt.ai/web), and [Canvas host](https://docs.bobolt.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.bobolt.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.bobolt.ai/start/wizard), and [doctor](https://docs.bobolt.ai/gateway/doctor).
- [Pi agent runtime](https://docs.bobolt.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.bobolt.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.bobolt.ai/concepts/groups).
- [Media pipeline](https://docs.bobolt.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.bobolt.ai/nodes/audio).

### Channels

- [Channels](https://docs.bobolt.ai/channels): [WhatsApp](https://docs.bobolt.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.bobolt.ai/channels/telegram) (grammY), [Slack](https://docs.bobolt.ai/channels/slack) (Bolt), [Discord](https://docs.bobolt.ai/channels/discord) (discord.js), [Google Chat](https://docs.bobolt.ai/channels/googlechat) (Chat API), [Signal](https://docs.bobolt.ai/channels/signal) (signal-cli), [BlueBubbles](https://docs.bobolt.ai/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.bobolt.ai/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.bobolt.ai/channels/msteams) (extension), [Matrix](https://docs.bobolt.ai/channels/matrix) (extension), [Zalo](https://docs.bobolt.ai/channels/zalo) (extension), [Zalo Personal](https://docs.bobolt.ai/channels/zalouser) (extension), [WebChat](https://docs.bobolt.ai/web/webchat).
- [Group routing](https://docs.bobolt.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.bobolt.ai/channels).

### Apps + nodes

- [macOS app](https://docs.bobolt.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.bobolt.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.bobolt.ai/nodes/talk) overlay, [WebChat](https://docs.bobolt.ai/web/webchat), debug tools, [remote gateway](https://docs.bobolt.ai/gateway/remote) control.
- [iOS node](https://docs.bobolt.ai/platforms/ios): [Canvas](https://docs.bobolt.ai/platforms/mac/canvas), [Voice Wake](https://docs.bobolt.ai/nodes/voicewake), [Talk Mode](https://docs.bobolt.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.bobolt.ai/platforms/android): [Canvas](https://docs.bobolt.ai/platforms/mac/canvas), [Talk Mode](https://docs.bobolt.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.bobolt.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.bobolt.ai/tools/browser): dedicated bobolt Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.bobolt.ai/platforms/mac/canvas): [A2UI](https://docs.bobolt.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.bobolt.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.bobolt.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.bobolt.ai/automation/cron-jobs); [webhooks](https://docs.bobolt.ai/automation/webhook); [Gmail Pub/Sub](https://docs.bobolt.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.bobolt.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.bobolt.ai/concepts/channel-routing), [retry policy](https://docs.bobolt.ai/concepts/retry), and [streaming/chunking](https://docs.bobolt.ai/concepts/streaming).
- [Presence](https://docs.bobolt.ai/concepts/presence), [typing indicators](https://docs.bobolt.ai/concepts/typing-indicators), and [usage tracking](https://docs.bobolt.ai/concepts/usage-tracking).
- [Models](https://docs.bobolt.ai/concepts/models), [model failover](https://docs.bobolt.ai/concepts/model-failover), and [session pruning](https://docs.bobolt.ai/concepts/session-pruning).
- [Security](https://docs.bobolt.ai/gateway/security) and [troubleshooting](https://docs.bobolt.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.bobolt.ai/web) + [WebChat](https://docs.bobolt.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.bobolt.ai/gateway/tailscale) or [SSH tunnels](https://docs.bobolt.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.bobolt.ai/install/nix) for declarative config; [Docker](https://docs.bobolt.ai/install/docker)-based installs.
- [Doctor](https://docs.bobolt.ai/gateway/doctor) migrations, [logging](https://docs.bobolt.ai/logging).
...
- **[Gateway WebSocket network](https://docs.bobolt.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.bobolt.ai/gateway)).
- **[Tailscale exposure](https://docs.bobolt.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.bobolt.ai/gateway/remote)).
- **[Browser control](https://docs.bobolt.ai/tools/browser)** — bobolt‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.bobolt.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.bobolt.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.bobolt.ai/nodes/voicewake) + [Talk Mode](https://docs.bobolt.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.bobolt.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

Bobolt can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (Bobolt enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.bobolt.ai/gateway/tailscale) · [Web surfaces](https://docs.bobolt.ai/web)
...
Details: [Remote access](https://docs.bobolt.ai/gateway/remote) · [Nodes](https://docs.bobolt.ai/nodes) · [Security](https://docs.bobolt.ai/gateway/security)
...
Details: [Nodes](https://docs.bobolt.ai/nodes) · [macOS app](https://docs.bobolt.ai/platforms/macos) · [Gateway protocol](https://docs.bobolt.ai/concepts/architecture)
...
Details: [Session tools](https://docs.bobolt.ai/concepts/session-tool)
...
- Controlled via `bobolt nodes …`.

Runbook: [iOS connect](https://docs.bobolt.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.bobolt.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.bobolt/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.bobolt/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.bobolt/bobolt.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.bobolt.ai/gateway/configuration)
...
Details: [Security guide](https://docs.bobolt.ai/gateway/security) · [Docker + sandboxing](https://docs.bobolt.ai/install/docker) · [Sandbox config](https://docs.bobolt.ai/gateway/configuration)

### [WhatsApp](https://docs.bobolt.ai/channels/whatsapp)

- Link the device: `pnpm bobolt channels login` (stores creds in `~/.bobolt/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.bobolt.ai/channels/telegram)
...
### [Slack](https://docs.bobolt.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.bobolt.ai/channels/discord)
...
### [Signal](https://docs.bobolt.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.bobolt.ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.bobolt.ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.bobolt.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.bobolt.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.bobolt.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.bobolt.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.bobolt.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.bobolt.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.bobolt.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.bobolt.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.bobolt.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.bobolt.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.bobolt.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.bobolt.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.bobolt.ai/platforms/windows), [Linux](https://docs.bobolt.ai/platforms/linux), [macOS](https://docs.bobolt.ai/platforms/macos), [iOS](https://docs.bobolt.ai/platforms/ios), [Android](https://docs.bobolt.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.bobolt.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.bobolt.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.bobolt.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.bobolt.ai/gateway/bonjour)
- [Gateway pairing](https://docs.bobolt.ai/gateway/pairing)
- [Remote gateway README](https://docs.bobolt.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.bobolt.ai/web/control-ui)
- [Dashboard](https://docs.bobolt.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.bobolt.ai/gateway/health)
- [Gateway lock](https://docs.bobolt.ai/gateway/gateway-lock)
- [Background process](https://docs.bobolt.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.bobolt.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.bobolt.ai/logging)

## Deep dives

- [Agent loop](https://docs.bobolt.ai/concepts/agent-loop)
- [Presence](https://docs.bobolt.ai/concepts/presence)
- [TypeBox schemas](https://docs.bobolt.ai/concepts/typebox)
- [RPC adapters](https://docs.bobolt.ai/reference/rpc)
- [Queue](https://docs.bobolt.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.bobolt.ai/tools/skills-config)
- [Default AGENTS](https://docs.bobolt.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.bobolt.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.bobolt.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.bobolt.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.bobolt.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.bobolt.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.bobolt.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.bobolt.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.bobolt.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.bobolt.ai/platforms/mac/voicewake)
- [iOS node](https://docs.bobolt.ai/platforms/ios)
- [Android node](https://docs.bobolt.ai/platforms/android)
- [Windows (WSL2)](https://docs.bobolt.ai/platforms/windows)
- [Linux app](https://docs.bobolt.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.bobolt.ai/gmail-pubsub](https://docs.bobolt.ai/automation/gmail-pubsub)

## Molty

Bobolt was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [bobolt.ai](https://bobolt.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@bobolt](https://x.com/bobolt)
...
<p align="left">
  ...
  <a href="https://github.com/ryancnelson"><img src="https://avatars.githubusercontent.com/u/347171?v=4&s=48" width="48" height="48" alt="ryancnelson" title="ryancnelson"/></a> <a href="https://github.com/search?q=Samrat%20Jha"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="Samrat Jha" title="Samrat Jha"/></a> <a href="https://github.com/search?q=seans-boboltbot"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="seans-boboltbot" title="seans-boboltbot"/></a> <a href="https://github.com/senoldogann"><img src="https://avatars.githubusercontent.com/u/45736551?v=4&s=48" width="48" height="48" alt="senoldogann" title="senoldogann"/></a> <a href="https://github.com/Seredeep"><img src="https://avatars.githubusercontent.com/u/22802816?v=4&s=48" width="48" height="48" alt="Seredeep" title="Seredeep"/></a> <a href="https://github.com/sergical"><img src="https://avatars.githubusercontent.com/u/3760543?v=4&s=48" width="48" height="48" alt="sergical" title="sergical"/></a> <a href="https://github.com/search?q=shatner"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="shatner" title="shatner"/></a> <a href="https://github.com/shiv19"><img src="https://avatars.githubusercontent.com/u/9407019?v=4&s=48" width="48" height="48" alt="shiv19" title="shiv19"/></a> <a href="https://github.com/shiyuanhai"><img src="https://avatars.githubusercontent.com/u/1187370?v=4&s=48" width="48" height="48" alt="shiyuanhai" title="shiyuanhai"/></a> <a href="https://github.com/Shrinija17"><img src="https://avatars.githubusercontent.com/u/199155426?v=4&s=48" width="48" height="48" alt="Shrinija17" title="Shrinija17"/></a>

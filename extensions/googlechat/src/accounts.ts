...
export function listGoogleChatAccountIds(cfg: BoboltConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: BoboltConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: BoboltConfig): ResolvedGoogleChatAccount[] {

...
export function listZalouserAccountIds(cfg: BoboltConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: BoboltConfig): string {
...
function mergeZalouserAccountConfig(cfg: BoboltConfig, accountId: string): ZalouserAccountConfig {

...
export function listBlueBubblesAccountIds(cfg: BoboltConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: BoboltConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: BoboltConfig): ResolvedBlueBubblesAccount[] {

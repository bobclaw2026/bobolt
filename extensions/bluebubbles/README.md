...
This directory contains the **BlueBubbles external channel plugin** for Bobolt.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `bobolt/plugin-sdk` helpers.

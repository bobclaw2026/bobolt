...
- Version alignment with core Bobolt release numbers.
...
- First public release of the @bobolt/voice-call plugin.
...
- CLI: `bobolt voicecall` commands (call/start/continue/speak/end/status/tail/expose).

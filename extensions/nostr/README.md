...
Nostr DM channel plugin for Bobolt using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Bobolt. It enables your bot to:
...
# Configure bobolt to use local relay

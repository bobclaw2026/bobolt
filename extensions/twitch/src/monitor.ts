...
import type { ReplyPayload, BoboltConfig } from "bobolt/plugin-sdk";
import { createReplyPrefixOptions } from "bobolt/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as BoboltConfig;

...
export function listMattermostAccountIds(cfg: BoboltConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: BoboltConfig): string {
...
export function listEnabledMattermostAccounts(cfg: BoboltConfig): ResolvedMattermostAccount[] {

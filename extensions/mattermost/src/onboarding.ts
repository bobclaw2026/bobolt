import type { ChannelOnboardingAdapter, BoboltConfig, WizardPrompter } from "bobolt/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.bobolt.ai/channels/mattermost",
    ].join("\n"),

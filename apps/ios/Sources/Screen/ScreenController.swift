...
final class ScreenController {
    ...
    /// Callback invoked when an bobolt:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = BoboltKitResources.bundle
...
/// Handles navigation policy to intercept bobolt:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept bobolt:// deep links.
        if url.scheme?.lowercased() == "bobolt" {

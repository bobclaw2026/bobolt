...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = BoboltLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = BoboltLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.bobolt.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(BoboltLocationMode.off.rawValue)
                            Text("While Using").tag(BoboltLocationMode.whileUsing.rawValue)
                            Text("Always").tag(BoboltLocationMode.always.rawValue)
                        }
                        ...
                        Text("Keeps the screen awake while Bobolt is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = BoboltLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private var locationMode: BoboltLocationMode {
        BoboltLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }

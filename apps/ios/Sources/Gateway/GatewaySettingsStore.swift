...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.bobolt.gateway"
    private static let nodeService = "ai.bobolt.node"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.bobolt.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.bobolt.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("bobolt-gateway.log")
    }

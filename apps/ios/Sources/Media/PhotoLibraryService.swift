...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: BoboltPhotosLatestParams) async throws -> BoboltPhotosLatestPayload {
        ...
        var results: [BoboltPhotoPayload] = []
        ...
        return BoboltPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> BoboltPhotoPayload
    {

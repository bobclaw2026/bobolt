...
@MainActor
public struct BoboltChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: BoboltChatViewModel
    ...
    private var visibleMessages: [BoboltChatMessage] {
        let base: [BoboltChatMessage]
    ...
    private func mergeToolResults(in messages: [BoboltChatMessage]) -> [BoboltChatMessage] {
    ...
    private func isToolResultMessage(_ message: BoboltChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: BoboltChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: BoboltChatMessage) -> String {

...
public typealias BoboltPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias BoboltPlatformImage = UIImage
#endif

public struct BoboltChatUsageCost: Codable, Hashable, Sendable {
...
public struct BoboltChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: BoboltChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(BoboltChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct BoboltChatMessageContent: Codable, Hashable, Sendable {
...
public struct BoboltChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [BoboltChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: BoboltChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [BoboltChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: BoboltChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(BoboltChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([BoboltChatMessageContent].self, forKey: .content) {
...
public struct BoboltChatHistoryPayload: Codable, Sendable {
...
public struct BoboltSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct BoboltSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [BoboltSessionPreviewItem]
}

public struct BoboltSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [BoboltSessionPreviewEntry]

    public init(ts: Int, previews: [BoboltSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct BoboltChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct BoboltChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct BoboltAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct BoboltChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct BoboltGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct BoboltPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: BoboltPlatformImage?
...
public struct BoboltChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String

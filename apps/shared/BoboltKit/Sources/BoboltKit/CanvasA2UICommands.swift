...
public enum BoboltCanvasA2UICommand: String, Codable, Sendable {
...
public struct BoboltCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct BoboltCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {

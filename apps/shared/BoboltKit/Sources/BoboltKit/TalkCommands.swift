...
public enum BoboltTalkCommand: String, Codable, Sendable {
...
public struct BoboltTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct BoboltTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String

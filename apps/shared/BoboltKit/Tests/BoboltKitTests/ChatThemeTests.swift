...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = BoboltChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = BoboltChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)

## Bobolt Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_bobolt-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm bobolt gateway --port 18789 --verbose
```

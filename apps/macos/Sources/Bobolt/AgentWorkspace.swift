...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.bobolt", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return BoboltConfigFile.defaultWorkspaceURL() }

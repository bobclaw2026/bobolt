...
extension ProcessInfo {
    ...
    /// Nix deployments may write defaults into a stable suite (`ai.bobolt.mac`) even if the shipped
    ...
    static func resolveNixMode(
        ...
        if standard.bool(forKey: "bobolt.nixMode") { return true }
        ...
        if isAppBundle, let stableSuite, stableSuite.bool(forKey: "bobolt.nixMode") { return true }

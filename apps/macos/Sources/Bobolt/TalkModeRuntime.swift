...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.bobolt", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.bobolt", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [BoboltChatMessage] = messages.compactMap { item in

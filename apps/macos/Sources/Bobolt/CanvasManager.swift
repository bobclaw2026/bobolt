...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.bobolt", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Bobolt/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__bobolt__/a2ui/").absoluteString + "?platform=macos"
    }

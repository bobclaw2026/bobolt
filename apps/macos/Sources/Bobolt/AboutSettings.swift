...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/bobolt/bobolt") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/bobolt/bobolt")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://bobolt.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "BoboltBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "BoboltBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "BoboltGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "BoboltGitCommit") as? String) ??
            "unknown"
    }

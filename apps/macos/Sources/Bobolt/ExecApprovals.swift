...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.bobolt", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        BoboltPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        BoboltPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }

...
enum UIStrings {
    static let welcomeTitle = "Welcome to Bobolt"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: BoboltOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: BoboltChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g bobolt@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: BoboltChatViewModel(

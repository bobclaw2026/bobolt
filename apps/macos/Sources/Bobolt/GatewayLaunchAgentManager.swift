...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.bobolt", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".bobolt/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.boboltCommand(
            subcommand: "gateway",

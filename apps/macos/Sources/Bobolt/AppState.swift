...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = BoboltConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = BoboltConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = BoboltConfigFile.loadDict()
            ...
            BoboltConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/bobolt"
        state.remoteCliPath = ""
        return state
    }
}

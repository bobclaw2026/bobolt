...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.bobolt", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Bobolt windows, but below the system’s pop-up menus.

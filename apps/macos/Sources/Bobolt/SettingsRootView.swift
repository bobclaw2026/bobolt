...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .boboltSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? BoboltPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? BoboltPaths.stateDirURL.path
...
extension Notification.Name {
    static let boboltSelectSettingsTab = Notification.Name("boboltSelectSettingsTab")
}

...
Bobolt treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.bobolt/settings/voicewake.json`

Shape:

```json
{ "triggers": ["bobolt", "claude", "computer"], "updatedAtMs": 1730000000000 }
```

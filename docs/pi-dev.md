...
This guide summarizes a sane workflow for working on the pi integration in Bobolt.
...
- Trigger the agent directly:
  - `pnpm bobolt agent --message "Hello" --thinking low`
...
State lives under the Bobolt state directory. Default is `~/.bobolt`. If `OPENCLAW_STATE_DIR` is set, use that directory instead.

To reset everything:

- `bobolt.json` for config
...
- [https://docs.bobolt.ai/testing](https://docs.bobolt.ai/testing)
- [https://docs.bobolt.ai/start/getting-started](https://docs.bobolt.ai/start/getting-started)

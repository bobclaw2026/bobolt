...
Deploy Bobolt on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/bobolt` — Control UI
...
- `OPENCLAW_STATE_DIR=/data/.bobolt` (recommended)
...
This exports your Bobolt state + workspace so you can migrate to another host without losing config or memory.

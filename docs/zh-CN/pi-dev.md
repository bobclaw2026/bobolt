...
本指南总结了在 Bobolt 中开发 Pi 集成的合理工作流程。
...
状态存储在 Bobolt 状态目录下。默认为 `~/.bobolt`。如果设置了 `OPENCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.bobolt.ai/testing
- https://docs.bobolt.ai/start/getting-started

---
summary: "First-run onboarding flow for Bobolt (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Bobolt">
...
<Step title="CLI">
  ...
  The app can install the global `bobolt` CLI via npm/pnpm so terminal

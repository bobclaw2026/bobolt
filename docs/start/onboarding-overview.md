---
summary: "Overview of Bobolt onboarding options and flows"
read_when:
...
Bobolt supports multiple onboarding paths depending on where the Gateway runs
...
- [`bobolt onboard` command](/cli/onboard)

## macOS app onboarding

Use the Bobolt app when you want a fully guided setup on macOS. Docs:

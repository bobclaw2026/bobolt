...
You can point Bobolt at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Bobolt
...
- [Anthropic provider](/providers/anthropic) - Native Bobolt integration with Claude setup-token or API keys

---
summary: "Use Qianfan's unified API to access many models in Bobolt"
read_when:
...
3. Bobolt installed on your system
...
4. Copy the API key for use with Bobolt

## CLI setup

```bash
bobolt onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Bobolt Configuration](/gateway/configuration)

---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Bobolt"
read_when:
  - You want Xiaomi MiMo models in Bobolt
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Bobolt uses

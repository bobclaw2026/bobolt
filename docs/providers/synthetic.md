---
summary: "Use Synthetic's Anthropic-compatible API in Bobolt"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Bobolt registers it as the
...
Note: Bobolt's Anthropic client appends `/v1` to the base URL, so use

---
summary: "Use Qwen OAuth (free tier) in Bobolt"
read_when:
  - You want to use Qwen with Bobolt
...
If you already logged in with the Qwen Code CLI, Bobolt will sync credentials

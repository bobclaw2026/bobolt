...
- Same path: run the app from a fixed location (for Bobolt, `dist/Bobolt.app`).
...
Workaround: move files into the Bobolt workspace (`~/.bobolt/workspace`) if you want to avoid per-folder grants.

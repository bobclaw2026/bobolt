...
Bobolt has two separate “streaming” layers:
...
When block streaming is enabled, Bobolt can **merge consecutive block chunks**
...
When draft streaming is active, Bobolt disables block streaming for that reply to avoid double-streaming.

...
read_when:
  - You are building a Bobolt plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (bobolt.plugin.json)

Every plugin **must** ship a `bobolt.plugin.json` file in the **plugin root**.
Bobolt uses this manifest to validate configuration **without executing plugin

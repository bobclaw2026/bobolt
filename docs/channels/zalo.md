...
- Install via CLI: `bobolt plugins install @bobolt/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `bobolt plugins install ./extensions/zalo`
   - From npm (if published): `bobolt plugins install @bobolt/zalo`
...
- Approve via:
  - `bobolt pairing list zalo`
  - `bobolt pairing approve zalo <CODE>`
...
- Example: `bobolt message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `bobolt channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `bobolt logs --follow`
